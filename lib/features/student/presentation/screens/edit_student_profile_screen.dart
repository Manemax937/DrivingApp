// Create: lib/features/student/presentation/screens/edit_student_profile_screen.dart
  ...
  Future<void> _saveProfile() async {
    ...
    try {
      ...
      if (studentsQuery.docs.isNotEmpty) {
        await studentsQuery.docs.first.reference.update({
          'full_name': fullName,
          'phone': phone,
          'updated_at': FieldValue.serverTimestamp(),
        });
                              ...
                              child: Form(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    _buildTextField(
                                      controller: TextEditingController(
                                        text: _role?.toUpperCase() ?? 'STUDENT',
                                      ),
                                      label: 'Role',
                                      icon: Icons.badge,
